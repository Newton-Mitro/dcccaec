...
class SettingSeeder extends Seeder
{
    public function run()
    {
        $settings = [
            // Basic site info
            ['key' => 'site_name', 'value' => 'DCCCEC'],
            ['key' => 'site_email', 'value' => 'info@dcccec.com'],
            ['key' => 'site_logo', 'value' => '/logo.png'],
            ['key' => 'maintenance_mode', 'value' => '0'],

            // Social links (JSON)
            ['key' => 'facebook', 'value' => 'https://facebook.com/dcccec'],
            ['key' => 'twitter', 'value' => 'https://twitter.com/dcccec'],
            ['key' => 'instagram', 'value' => 'https://instagram.com/dcccec'],
            ['key' => 'linkedin', 'value' => 'https://linkedin.com/dcccec'],
            ['key' => 'youtube', 'value' => 'https://youtube.com/dcccec'],

            // Contact info
            ['key' => 'contact_address', 'value' => '123 Main Street, City, Country'],
            ['key' => 'contact_phone', 'value' => '+1234567890'],
            ['key' => 'contact_email', 'value' => 'contact@dcccec.com'],
