...
export default function Dashboard() {
    const { stats, monthlyVisitors, routeVisits, latestNotices, jobApplications, visitors, media, contactMessages }: any = usePage().props;
                    ...
                    <div className="rounded-xl border border-sidebar-border/70 bg-white p-4 shadow-sm dark:border-sidebar-border dark:bg-neutral-900">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            {media.map((m: any) => (
                                ...
                                // <img key={m.id} src={m.url} alt="" className="object-cover w-full h-20 rounded" />
                            ))}
                        </div>
                    </div>
