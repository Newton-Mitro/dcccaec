...
const TeamCardItem: React.FC<TeamCardItemProps> = ({ member, index }) => {
    ...
    return (
                    ...
                    <div className="flex min-h-62 w-full flex-col justify-center rounded-2xl border-1 border-border bg-card p-6 md:ml-72 md:pl-32">
                        <div className="">
                            <Link href={route('site.teams.show', member.id)} className="">
                                ...
                                {member.department && <p className="mt-1 text-xs text-accent">{member.department}</p>}
                                ...
                                <div className="mt-4 flex space-x-2">
                                    {socials.map((s, idx) => (
                                        <a
                                            ...
                                            className="rounded-full bg-accent/10 p-2 text-accent transition-colors hover:bg-secondary"
                                        >
                                            {s.icon}
                                        </a>
                                    ))}
        ...
        //     {/* Inner content container-custom  rotated back and centered */}
