                ...
                <div className="container-custom mx-auto px-4 py-16">
                    <div className="flex flex-col items-center gap-16 md:flex-row">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <h2 className="text-xl text-muted-foreground">{team.designation}</h2>
                            {team.department && <p className="text-sm font-medium text-accent">{team.department}</p>}
                            {/* Social Links */}
                            {/* Socials */}
                            {socials.length > 0 && (
                                <div className="mt-4 flex space-x-2">
                                    {socials.map((s, idx) => (
                                        <a
                                            ...
                                            className="rounded-full bg-secondary/10 p-2 text-secondary transition-colors hover:bg-accent"
                                        >
                                            {s.icon}
                                        </a>
                                    ))}
