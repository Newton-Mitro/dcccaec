        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6">
                <div className="mb-4 flex flex-col items-start justify-between gap-2 sm:flex-row">
                    <HeadingSmall title="Users" description="Manage all platform users" />
                    <Link
                ...
                <div className="h-[calc(100vh-250px)] overflow-auto rounded border border-gray-200 dark:border-gray-700">
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            {users.data.map((user) => (
                                <tr key={user.id} className="border-b even:bg-gray-50 dark:even:bg-gray-900">
                ...
                <div className="mt-4 flex flex-col items-center justify-between gap-2 md:flex-row">
                    <span className="text-sm text-gray-600 dark:text-gray-400">Showing {users.data.length} results</span>
